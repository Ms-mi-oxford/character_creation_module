...
def attack(char_name: str, char_class: str) -> str:
    """Функция определяет количество нанесенного урона."""
    damage = 5
...
def defence(char_name: str, char_class: str) -> str:
    """Функция определяет количество заблокированного урона."""
    damage = 10
    if char_class == 'warrior':
        damage += randint(5, 10)
    if char_class == 'mage':
...
def special(char_name: str, char_class: str) -> str:
    """Функция определяет специальные умения персонажей."""
    skill: str = ''
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция, позволяющая выбрать персонажа игры."""
    approve_choice: str = ''
    char_class: str = ''
